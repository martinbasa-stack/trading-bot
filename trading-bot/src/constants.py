#My constants File locations
FILE_PATH_STRATEGY = "config/strategies.json"
FILE_PATH_BASIC = "config/settings.json"
FILE_PATH_EXCHANGE_INFO = "data/_exchange_info_data.json"
FILE_PATH_USER_DATA_JSON = "data/_userdata.json"
FILE_PATH_USER_DATA_CSV = "data/_userdata.csv"
FILE_PATH_HIST_STRATEGY = "data/_histStrategyVal.json"
FILE_PATH_FEAR_GREAD = "data/_fearAndGreed.json"
LOG_PATH_SETTINGS = "logs/settings_change.log"
LOG_PATH_MAIN = "logs/main.log"
LOG_PATH_STRATEGY = "logs/strategy.log"
LOG_PATH_BINANCE_API = "logs/Binance_API.log"
LOG_PATH_APP = "logs/app.log"
