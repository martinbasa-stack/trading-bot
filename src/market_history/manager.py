...
class MarketHistoryManager:
    ...
    def __init__(self, 
        ...
        self._data: Dict[int, PairHistory] = {}  # Pair -> PairHistory
    ...
    def get_table(self, pair, interval) -> IntervalData:
        ...
        with self._lock:
            if not self._data[pair].intervals[interval]:
                return None
            return self._data[pair].intervals[interval]
    ...
    # ------------------------------------------------------------------
    def _load_all(self):
        pair_intervals : dict[str, dict[str, object]] = self._get_pairs_intervals()
    ...
    def _cleanup(self):
        paths_to_keep = []
        pair_intervals = self._get_pairs_intervals()  
    ...
    def _missing_file_list(self) -> dict[str, dict[str, object]]:
        result  : dict[str, dict[str, object]] ={}
        pairs_intervals : dict[str, dict[str, object]] = self._get_pairs_intervals()
