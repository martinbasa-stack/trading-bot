...
from src.evm_api.constants import ARB_MAIN_RPC_URL
...
class EvmManager:
    ...
    def get_balances(self) -> dict[str, Balance]:
        ...
        try:            
            ...
            self._logger.error(f"get_balances error: {e}")
    ...
    def deposit_savings(self, symbol : str, amount :float):
        ...
        try:            
            with self._lock:                
                ...
                self._executor.sign_send(f"{symbol}_Deposit_savings", trx, ARB_MAIN_RPC_URL, True)
    ...
    def withdraw_savings(self, symbol : str, amount :float):
        ...
        try:            
            with self._lock:                
                ...
                self._executor.sign_send(f"{symbol}_Withdraw_savings", trx, ARB_MAIN_RPC_URL, True)
