...
class WebsocketConnection:
    ...
    def __init__(self,
        ...
        self._credentials_get = credentials_get
    ...
    def _get_api(self):
        try:
            ...
            self._api_key = self._credentials_get("B_API_KEY", "API_KEY")
            self._api_secret = self._credentials_get("B_API_SECRET", "API_SECRET")
