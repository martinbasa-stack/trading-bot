...
class StreamManager:
    ...
    def all_streams_available(self) -> bool: 
        ...
        try:  
            with self._lock:
                pair_list = list(self._get_pairs(filter_only="Binance").keys())
    ...
    def get_active_list(self) -> Dict[str, str]:
        ...
        Returns:
            Dict: 
                A dict of pairs as keys and interval as value.
        """
        try:
            with self._lock:
                active_list= {}
                for pair, data in self._data.items():
                    active_list[pair] = data.interval
                return active_list
        except Exception as e:
    ...
    def _cleanup(self):
        ...
        valid = set(self._get_pairs(filter_only="Binance").keys())
