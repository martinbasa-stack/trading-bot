...
def extract_settings_from_form(request) -> dict:
    ...
    try:
        data = {
            ...
            "sol_price_impact_lim" :float(request.form.get("sol_price_impact_lim")),
            "sol_timeout" : int(request.form.get("sol_timeout")),
            "evm_slippage_bps" : int(float(request.form.get("evm_slippage_bps"))*100),
            "evm_price_impact_lim" : float(request.form.get("evm_price_impact_lim")),
            "evm_timeout" : int(request.form.get("evm_timeout")),
