...
FILE_PATH_CRED   = BASE_DIR / "config" / "credentials.json"
...
FILE_PATH_FEAR_GREAD_HIST    = BASE_DIR / "data" / "_fearAndGreed_hist.csv"
FILE_PATH_WALLET  = BASE_DIR / "data" / "_wallet.json"
